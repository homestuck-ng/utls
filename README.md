...
[![Build Status](https://github.com/homestuck-ng/utls/actions/workflows/go.yml/badge.svg?branch=master)](https://github.com/homestuck-ng/utls/actions/workflows/go.yml)
[![godoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/homestuck-ng/utls#UConn)
...
so you are encouraged to use [godoc](https://godoc.org/github.com/homestuck-ng/utls#UConn).

_Note: Information provided below in this README.md could be obsolete. We welcome
any contributions to refresh the documentations in addition to code contributions._
...
It LGTM, but please open up Wireshark and check. If you see something — [say something](https://github.com/homestuck-ng/utls/issues).
...
There sure are. If you found one that approaches practicality at line speed — [please tell us](https://github.com/homestuck-ng/utls/issues).
...
See full list of `clientHelloID` values [here](https://godoc.org/github.com/homestuck-ng/utls#pkg-variables).  
...
1. Import this library (e.g. `import tls "github.com/homestuck-ng/utls"`)
